...
export type Media = {
  ...
  alt: string;
  /** légende visible quand la photo est présentée comme document */
  caption?: string;
...
export const MEDIAS = [
  {
    ...
    caption: 'Le matériel du club. Boxing Center Toulouse Minimes.',
    focus: '50% 45%',
  },
  {
    ...
    caption: 'Travail au sac. Boxing Center Toulouse Minimes.',
    focus: '55% 40%',
  },
  {
    ...
    caption: 'La salle. Boxing Center Toulouse Minimes.',
    bw: true,
    focus: '60% 45%',
  },
  {
    ...
    caption: "L'encadrement avant la montée sur le ring. Boxing Center Toulouse Minimes.",
    bw: true,
    focus: '45% 40%',
  },
  {
    ...
    caption: 'Travail technique aux pattes d’ours. Boxing Center Toulouse Minimes.',
    focus: '55% 35%',
  },
  {
    ...
    caption: 'Cours collectif. Boxing Center Toulouse Minimes.',
    focus: '50% 50%',
  },
  {
    ...
    caption: 'Échauffement à la corde. Boxing Center Toulouse Minimes.',
    focus: '45% 40%',
  },
  {
    ...
    caption: 'Face au ring. Boxing Center Toulouse Minimes.',
    focus: '50% 40%',
  },
  {
    ...
    caption: 'Le ring. Boxing Center Toulouse Minimes.',
    focus: '55% 50%',
  },
  {
    ...
    caption: 'Sparring encadré. Boxing Center Toulouse Minimes.',
    focus: '50% 35%',
  },
  {
    ...
    caption: 'Les bandes, avant tout le reste. Boxing Center Toulouse Minimes.',
    focus: '55% 45%',
  },
  {
  ...
  },
  {
    ...
    caption: 'La garde. Boxing Center Toulouse Minimes.',
    pair: 'garde',
    focus: '50% 35%',
  },
  {
    ...
    caption: 'Le club pendant un entraînement. Boxing Center Toulouse Minimes.',
    focus: '50% 45%',
  },
  {
    ...
    caption: 'Travail des appuis. Boxing Center Toulouse Minimes.',
    focus: '50% 45%',
  },
  {
    ...
    caption: 'Aux pattes d’ours avec le coach. Boxing Center Toulouse Minimes.',
    bw: true,
    focus: '55% 40%',
  },
  {
    ...
    caption: 'Enchaînements aux pattes d’ours. Boxing Center Toulouse Minimes.',
    focus: '55% 40%',
  },
  {
  ...
  },
  {
    ...
    caption: 'Devant la fresque du club. Boxing Center Toulouse Minimes.',
    pair: 'paos',
    focus: '55% 40%',
  },
  {
    ...
    caption: 'Avant la première séance. Boxing Center Toulouse Minimes.',
    focus: '50% 40%',
  },
  {
  ...
  },
  {
    ...
    caption: 'Le coach met la pression, le boxeur répond. Boxing Center Toulouse Minimes.',
    focus: '55% 45%',
  },
  {
  ...
  },
  {
    ...
    caption: 'Travail au corps. Boxing Center Toulouse Minimes.',
    pair: 'corps',
    focus: '50% 40%',
  },
